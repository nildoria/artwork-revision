...
function redirect_root_url()
{
    if (is_front_page() && !is_admin()) {
        wp_redirect('https://allaround.co.il/', 301);
        exit;
    }
}
add_action('template_redirect', 'redirect_root_url');
...
// Hook to execute after an order is processed and create post to 'artwork' post type
// add_action('woocommerce_checkout_order_processed', 'create_artwork_post_on_order_placement', 10, 3);

// function create_artwork_post_on_order_placement($order_id, $posted_data, $order)
// {
...
//             if ($comment_content) {
//                 $acf_comments[] = array(
//                     'artwork_comments_texts' => $comment_content
//                 );
//             }
//         }

//         // Update the ACF repeater field with the new comments
//         update_field('artwork_comments', $acf_comments, $post_id);
//     }
// }
